  ...
  return (
    ...
    >
      <div className="col-span-4 h-full w-full space-y-6">
        <FormSection title="Basic Information" description="Enter series details">
          <Form.Field
            {...{
              name: "body.title",
              label: "Title",
        ...
        <FormSection title="Media" description="Upload images and icons for this series">
        ...
        <FormSection title="Display Settings" description="Configure how this series appears to users">
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
      ...
      <div className="col-span-4 flex h-auto w-full flex-col justify-between gap-4 border-t pt-4 sm:flex-row sm:items-center">
        ...
        <div className="flex flex-col-reverse gap-2 sm:flex-row sm:items-center">
          ...
          <Form.Submit label="Create Series" disabled={isLoading} isLoading={isLoading} />
        </div>
      </div>
    </Form>
  );

  ...
  return (
    ...
    >
      <div className="col-span-4 h-full w-full">
        <FormSection title="Inventory Details" description="Edit inventory details">
      ...
      <div className="col-span-4 flex h-auto w-full flex-row items-center justify-between gap-x-4 p-0 py-4">
        ...
        <div className="flex flex-row items-center gap-2">
          ...
          <Form.Submit disabled={updateInventory.isPending} isLoading={updateInventory.isPending} />
        </div>
      </div>
    </Form>
  );

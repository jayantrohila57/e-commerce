  ...
  return (
    ...
    >
      <div className="col-span-4 h-full w-full">
        <FormSection title="Category Details" description="Enter category information">
          <Form.Field
            {...{
              name: "body.title",
              label: "Title",
        ...
        <FormSection title="Display Settings" description="Control how this category is shown to users">
      ...
      <div className="col-span-4 flex h-auto w-full flex-row items-center justify-between gap-x-4 p-0 py-4">
        ...
        <div className="flex flex-row items-center gap-2">
          ...
          <Form.Submit disabled={createCategory.isPending} isLoading={createCategory.isPending} />
        </div>
      </div>
    </Form>
  );

...
| ✅      | Image upload field: RAF cancelled on unmount and when upload completes; refs used to avoid stale closures                                                |
| ✅      | Currency field stores string; schemas use `z.coerce.number()` where numeric value is required                                                            |

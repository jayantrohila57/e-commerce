...
const sections: NavItem<Route>[] = [
  { id: 'commerce', label: 'Commerce', href: PATH.ACCOUNT.COMMERCE, icon: <LocateIcon size={14} /> },
  ...
  { id: 'shipment', label: 'Shipment', href: PATH.ACCOUNT.SHIPMENT, icon: <LocateIcon size={14} /> },
